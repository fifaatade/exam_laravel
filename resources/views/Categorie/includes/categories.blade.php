            ...
            @foreach($categorie_list as $items)
                ...
                <tr>
                    ...
                    <td class=" text-center ">
                        <a class="btn btn-outline-warning mx-2 my-2"  href="{{route('editCategorie',$items['id'])}}" >modifier</a>
                        <a class="btn btn-outline-danger" href="{{route('deleteCategorie',$items['id'])}}">supprimer</a>
                    </td>                
                </tr>
            @endforeach
        </tbody>
